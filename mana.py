...
class Management: 
    def __init__(self, root, id):
        ...
        self.show_customer_btn = Button(self.customer_func_frame, text = "Show customer list", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.show_customer_list).pack(pady = 10)
        self.add_customer_btn = Button(self.customer_func_frame, text = "Add customer", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.add_customer).pack(pady = 10)
        self.delete_customer_btn = Button(self.customer_func_frame, text = "Delete customer", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.delete_customer).pack(pady = 10)
        self.search_customer_btn = Button(self.customer_func_frame, text = "Search customer", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.search_customer).pack(pady = 10)
        ...
        self.show_bill_btn = Button(self.bill_func_frame, text = "Show bill list", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.show_bill_list).pack(pady = 10)
        self.add_bill_btn = Button(self.bill_func_frame, text = "Add bill", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.add_bill).pack(pady = 10)
        self.delete_bill_btn = Button(self.bill_func_frame, text = "Delete bill", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.delete_bill).pack(pady = 10)
        self.search_bill_btn = Button(self.bill_func_frame, text = "Search bill", fg = "#FFFFFA", bg = '#c1e2cd', width = 15, font=('Montserrat Bold',15), command = self.search_bill).pack(pady = 10)
    ...
    def show_staff_list(self):
        ...
        for i in range(len(self.staffs)):
            for j in range(len(self.staffs[0])):
                self.e = Label(self.staff_wrk_frame,bd = 5, width = 12, wraplength = 100, bg = '#FFFFFA', text = self.staffs[i][j], fg='#3b225c',font=('Montserrat Bold',16))
    ...
    def search_staff_data(self):
        ...
        for i in range(len(self.staffs)):
            if self.staffs[i][0] == id:
                for j in range(len(self.staffs[0])):
                    self.e = Label(self.staff_wrk_frame, bd = 5, width = 12, wraplength = 100, bg = '#FFFFFA',text = self.staffs[0][j], fg='#3b225c',font=('Montserrat Bold',16))
    ...
    def show_product_list(self):
        ...
        for i in range(len(self.products)):
            for j in range(len(self.products[0])):
                self.e = Label(self.product_wrk_frame,bd = 5, width = 12, wraplength = 100, bg = '#FFFFFA' ,text = self.products[i][j], fg='#3b225c',font=('Montserrat Bold',16))
                self.e.grid(row=i, column=j)
    ...
    def search_product_data(self):
        ...
        for i in range(len(self.products)):
            if self.products[i][0] == id:
                for j in range(len(self.products[0])):
                    self.e = Label(self.product_wrk_frame, bd = 5, width = 12, wraplength = 100, bg = '#FFFFFA' ,text = self.products[0][j], fg='#3b225c',font=('Montserrat Bold',16))
                    self.e.grid(row=2, column=j)
                    self.e = Label(self.product_wrk_frame, bd = 5, width = 12, wraplength = 100, bg = '#FFFFFA' ,text = self.products[i][j], fg='#3b225c',font=('Montserrat Bold',16))
                    self.e.grid(row=3, column=j)
                return
    ...
    def show_customer_list(self):
        ...
        for i in range(len(self.customers)):
            for j in range(len(self.customers[0])):
                self.e = Label(self.customer_wrk_frame,bd = 5, width = 14, wraplength = 100, bg = '#FFFFFA' ,text = self.customers[i][j], fg='#3b225c',font=('Montserrat Bold',16))
                self.e.grid(row=i, column=j)
    
    def add_customer(self):
        self.clear_frame()
        
        self.add_customer_tittle = Label(self.customer_wrk_frame, text = "Add customer", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 0, column = 0)
        self.add_customer_id = Label(self.customer_wrk_frame, text = "ID", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 1, column = 0)
        self.add_customer_id_e = Entry(self.customer_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_customer_id_e.grid(row = 1, column = 1)
        self.add_customer_name = Label(self.customer_wrk_frame, text = "Name", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 2, column = 0)
        self.add_customer_name_e = Entry(self.customer_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_customer_name_e.grid(row = 2, column = 1)
        self.add_customer_dob = Label(self.customer_wrk_frame, text = "Dob", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 3, column = 0)
        self.add_customer_dob_e = Entry(self.customer_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_customer_dob_e.grid(row = 3, column = 1)
        self.add_customer_contact_number = Label(self.customer_wrk_frame, text = "Contact Number", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 4, column = 0)
        self.add_customer_contact_number_e = Entry(self.customer_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_customer_contact_number_e.grid(row = 4, column = 1)
        self.add_customer_email = Label(self.customer_wrk_frame, text = "Email", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 5, column = 0)
        self.add_customer_email_e = Entry(self.customer_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_customer_email_e.grid(row = 5, column = 1)
        self.add_customer_address = Label(self.customer_wrk_frame, text = "Address", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 6, column = 0)
        self.add_customer_address_e = Entry(self.customer_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_customer_address_e.grid(row = 6, column = 1)

        self.submit = Button(self.customer_wrk_frame, text = "Submit", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), command = self.add_customer_data).grid(row = 7, column = 0)

    def delete_customer(self):
        self.clear_frame()

        self.add_customer_id = Label(self.customer_wrk_frame, text = "Delete customer", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 0, column = 0)
        self.add_customer_id = Label(self.customer_wrk_frame, text = "ID", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 1, column = 0)
        self.add_customer_id_e = Entry(self.customer_wrk_frame, fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16), textvariable = StringVar())
        self.add_customer_id_e.grid(row = 1, column = 1)
        self.submit = Button(self.customer_wrk_frame, text = "Submit", fg = '#FFFFFA', bg = '#3b225c', font=('Montserrat Bold',16), command = self.delete_customer_data).place(x = 130, y = 100)

    def search_customer(self):
        self.clear_frame()

        self.add_customer_id = Label(self.customer_wrk_frame, text = "Search customer", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 0, column = 0)
        self.add_customer_id = Label(self.customer_wrk_frame, text = "ID", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 1, column = 0)
        self.add_customer_id_e = Entry(self.customer_wrk_frame,width = 12 ,fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16), textvariable = StringVar())
        self.add_customer_id_e.grid(row = 1, column = 1)
        self.submit = Button(self.customer_wrk_frame, text = "Submit", fg = '#FFFFFA', bg = '#3b225c', font=('Montserrat Bold',16), command = self.search_customer_data).place(x = 130, y = 150)
    ...
    def add_customer_data(self):
        ...
        if id == '' or name == '' or address == '' or dob == '' or contact_number == '' or email == '':
            mes = Label(self.customer_wrk_frame, text = "Invalid", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'))
            ...
            mes = Label(self.customer_wrk_frame, text = "Success", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'))
            mes.grid(row = 7, column = 1)
            mes.after(3000,lambda:mes.destroy())
    ...
    def delete_customer_data(self):
        id = self.add_customer_id_e.get()
        if id == "ID":
            mes = Label(self.customer_wrk_frame, text = "Id dont exist", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16))
            mes.grid(row = 4, column = 1)
            mes.after(3000,lambda:mes.destroy())
            return
        ...
        for i in range(len(self.customers)):
            if self.customers[i][0] == id:
                ...
                mes = Label(self.customer_wrk_frame, text = "Success", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16))
                mes.grid(row = 4, column = 1)
                mes.after(3000,lambda:mes.destroy())
                return
        mes = Label(self.customer_wrk_frame, text = "Id dont exist", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16))
    ...
    def search_customer_data(self):
        ...
        for i in range(len(self.customers)):
            if self.customers[i][0] == id:
                for j in range(len(self.customers[0])):
                    self.e = Label(self.customer_wrk_frame, bd = 5, width = 14, wraplength = 100, bg = '#FFFFFA' ,text = self.customers[0][j], fg='#3b225c',font=('Montserrat Bold',16))
                    self.e.grid(row=2, column=j)
                    self.e = Label(self.customer_wrk_frame, bd = 5, width = 14, wraplength = 100, bg = '#FFFFFA' ,text = self.customers[i][j], fg='#3b225c',font=('Montserrat Bold',16))
                    self.e.grid(row=3, column=j)
                return
    ...
    def show_bill_list(self):
        ...
        for i in range(len(self.bills)):
            for j in range(len(self.bills[0])):
                self.e = Label(self.bill_wrk_frame,bd = 5, width = 16, wraplength = 120, bg = '#FFFFFA' ,text = self.bills[i][j], fg='#3b225c',font=('Montserrat Bold',16))
                self.e.grid(row=i, column=j)
    
    def add_bill(self):
        self.clear_frame()
        
        self.add_bill_tittle = Label(self.bill_wrk_frame, text = "Add bill", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 0, column = 0)
        self.add_bill_id = Label(self.bill_wrk_frame, text = "Bill id", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 1, column = 0)
        self.add_bill_id_e = Entry(self.bill_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_bill_id_e.grid(row = 1, column = 1)
        self.add_bill_product_id = Label(self.bill_wrk_frame, text = "Product id", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 2, column = 0)
        self.add_bill_product_id_e = Entry(self.bill_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_bill_product_id_e.grid(row = 2, column = 1)
        self.add_bill_cost = Label(self.bill_wrk_frame, text = "Cost", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold')).grid(row = 3, column = 0)
        self.add_bill_cost_e = Entry(self.bill_wrk_frame, fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), textvariable = StringVar())
        self.add_bill_cost_e.grid(row = 3, column = 1)

        self.submit = Button(self.bill_wrk_frame, text = "Submit", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'), command = self.add_bill_data).grid(row = 4, column = 0)

    def delete_bill(self):
        self.clear_frame()

        self.add_bill_id = Label(self.bill_wrk_frame, text = "Delete bill", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 0, column = 0)
        self.add_bill_id = Label(self.bill_wrk_frame, text = "ID", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 1, column = 0)
        self.add_bill_id_e = Entry(self.bill_wrk_frame, fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16), textvariable = StringVar())
        self.add_bill_id_e.grid(row = 1, column = 1)
        self.submit = Button(self.bill_wrk_frame, text = "Submit", fg = '#FFFFFA', bg = '#3b225c', font=('Montserrat Bold',16), command = self.delete_bill_data).place(x = 130, y = 100)

    def search_bill(self):
        self.clear_frame()

        self.add_bill_id = Label(self.bill_wrk_frame, text = "Search bill", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 0, column = 0)
        self.add_bill_id = Label(self.bill_wrk_frame, text = "ID", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16)).grid(row = 1, column = 0)
        self.add_bill_id_e = Entry(self.bill_wrk_frame,width = 12 ,fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16), textvariable = StringVar())
        self.add_bill_id_e.grid(row = 1, column = 1)
        self.submit = Button(self.bill_wrk_frame, text = "Submit", fg = '#FFFFFA', bg = '#3b225c', font=('Montserrat Bold',16), command = self.search_bill_data).place(x = 130, y = 150)
    ...
    def add_bill_data(self):
        ...
        if id == '' or product_id == '' or cost == '':
            mes = Label(self.bill_wrk_frame, text = "Invalid", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'))
            mes.grid(row = 4, column = 1)
            mes.after(3000,lambda:mes.destroy())
        else:
            ...
            mes = Label(self.bill_wrk_frame, text = "Success", fg = '#6874E8', bg = 'white', font=('Microsoft Yahei UI light',16,'bold'))
            mes.grid(row = 4, column = 1)
            mes.after(3000,lambda:mes.destroy())
    ...
    def delete_bill_data(self):
        id = self.add_bill_id_e.get()
        if id == "Bill_id":
            mes = Label(self.bill_wrk_frame, text = "Id dont exist", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16))
            mes.grid(row = 4, column = 1)
            mes.after(3000,lambda:mes.destroy())
            return
        ...
        for i in range(len(self.bills)):
            if self.bills[i][0] == id:
                self.bills.pop(i)
                mes = Label(self.bill_wrk_frame, text = "Success", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16))
                mes.grid(row = 4, column = 1)
                mes.after(3000,lambda:mes.destroy())
                return
        mes = Label(self.bill_wrk_frame, text = "Id dont exist", fg = '#3b225c', bg = '#FFFFFA', font=('Montserrat Bold',16))
    ...
    def search_bill_data(self):
        ...
        for i in range(len(self.bills)):
            if self.bills[i][0] == id:
                for j in range(len(self.bills[0])):
                    self.e = Label(self.bill_wrk_frame, bd = 5, width = 16, wraplength = 120, bg = '#FFFFFA' ,text = self.bills[0][j], fg='#3b225c',font=('Montserrat Bold',16))
                    self.e.grid(row=2, column=j)
                    self.e = Label(self.bill_wrk_frame, bd = 5, width = 16, wraplength = 120, bg = '#FFFFFA' ,text = self.bills[i][j], fg='#3b225c',font=('Montserrat Bold',16))
                    self.e.grid(row=3, column=j)
                return
